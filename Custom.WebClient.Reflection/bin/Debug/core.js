...
Custom.DateRangeSlider=function(options){Custom.DateRangeSlider.initializeBase(this);this.date=$.extend({},options.date);this.offset=$.extend({},options.offset);}
Custom.DateRangeSlider.init=function(angular,module){module.directive('dateHigh',function(){
...
$p2_1.on('change',function($p3_0){
$p2_0.$apply(function(){
var $4_0=$p2_1.val();var $4_1=Date.parseDate($4_0).getTime();$p2_0.slider.offset.low=$4_1;});});}};});module.directive('dateRange',function(){
return {restrict:'A',link:function($p2_0,$p2_1,$p2_2,$p2_3){
$p2_0.slider.el=$p2_1;$p2_1.data('Custom.DateRangeSlider',$p2_0.slider);}};});module.directive('rangeTrack',function(){
return {restrict:'A',link:function($p2_0,$p2_1,$p2_2,$p2_3){
$p2_0.slider.trackEl=$p2_1;}};});module.directive('rangeThumb',function(){
return {restrict:'A',link:function($p2_0,$p2_1,$p2_2,$p2_3){
$p2_0.slider.thumbEl=$p2_1;}};});module.directive('rangeHigh',function(){
return {restrict:'A',link:function($p2_0,$p2_1,$p2_2,$p2_3){
...
$p2_0.$apply(function(){
if($p2_0.slider.lowEl){$p2_0.slider.lowEl.slider({max:$p2_0.slider.offset.high});$p2_0.slider.lowEl.slider('refresh');}});});}};});module.directive('rangeLow',function(){
return {restrict:'A',link:function($p2_0,$p2_1,$p2_2,$p2_3){
...
Custom.DateRangeSlider.prototype={el:null,trackEl:null,thumbEl:null,highEl:null,lowEl:null,setHeight:function(value){},setWidth:function(value){}}
