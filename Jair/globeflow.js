...
function GlobeFlow(globe, container, center, radio) {
    ...
    GlobeFlow.mitter = function (x, y, z) {
        var c = sqrt2div2;
    ...
    this.refresh = function () {
        ...
        this.Location[6] = p.translate(GlobeFlow.mitter(g.VectorX, g.VectorY, g.VectorZ).plot(r));
        this.Location[7] = p.translate(GlobeFlow.mitter(g.VectorX.image(), g.VectorY, g.VectorZ).plot(r));
        this.Location[8] = p.translate(GlobeFlow.mitter(g.VectorX, g.VectorY.image(), g.VectorZ).plot(r));
        this.Location[9] = p.translate(GlobeFlow.mitter(g.VectorX, g.VectorY, g.VectorZ.image()).plot(r));
        this.Location[10] = p.translate(GlobeFlow.mitter(g.VectorX.image(), g.VectorY.image(), g.VectorZ.image()).plot(r));
        this.Location[11] = p.translate(GlobeFlow.mitter(g.VectorX, g.VectorY.image(), g.VectorZ.image()).plot(r));
        this.Location[12] = p.translate(GlobeFlow.mitter(g.VectorX.image(), g.VectorY, g.VectorZ.image()).plot(r));
        this.Location[13] = p.translate(GlobeFlow.mitter(g.VectorX.image(), g.VectorY.image(), g.VectorZ).plot(r));
        ...
        this.Location[14] = p.translate(i);
        this.Location[15] = p.translate(j);
        this.Location[16] = p.translate(k);

        var l = i.image();
        var m = j.image();
        var n = k.image();

        this.Location[17] = p.translate(l);
        this.Location[18] = p.translate(m);
        this.Location[19] = p.translate(n);
    }
