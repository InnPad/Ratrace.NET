...
Custom.DateRangeSlider = function Custom_DateRangeSlider(options) {
    /// <param name="options" type="Object">
    /// </param>
    /// <field name="el" type="jQueryObject">
    /// Date range control div element
    /// </field>
    /// <field name="trackEl" type="jQueryObject">
    /// Date range track div element
    /// </field>
    /// <field name="thumbEl" type="jQueryObject">
    /// Date range thumb div element
    /// </field>
    /// <field name="highEl" type="jQueryObject">
    /// Date range high slider input element
    /// </field>
    /// <field name="lowEl" type="jQueryObject">
    /// Date range low slider input element
    /// </field>
    Custom.DateRangeSlider.initializeBase(this);
    this.date = $.extend({}, options.date);
    this.offset = $.extend({}, options.offset);
}
Custom.DateRangeSlider.init = function Custom_DateRangeSlider$init(angular, module) {
    ...
    module.directive('rangeTrack', function() {
        return { restrict: 'A', link: function(scope, element, attr, ngModel) {
            scope.slider.trackEl = element;
        } };
    });
    module.directive('rangeThumb', function() {
        return { restrict: 'A', link: function(scope, element, attr, ngModel) {
            scope.slider.thumbEl = element;
        } };
    });
    module.directive('rangeHigh', function() {
        return { restrict: 'A', link: function(scope, element, attr, ngModel) {
    ...
    module.directive('rangeLow', function() {
        return { restrict: 'A', link: function(scope, element, attr, ngModel) {
...
Custom.DateRangeSlider.prototype = {
    el: null,
    trackEl: null,
    thumbEl: null,
    highEl: null,
    ...
    setHeight: function Custom_DateRangeSlider$setHeight(value) {
        /// <param name="value" type="Number">
        /// </param>
    },
    
    setWidth: function Custom_DateRangeSlider$setWidth(value) {
        /// <param name="value" type="Number">
        /// </param>
    }
}
...
Custom.DateRangeSlider.registerClass('Custom.DateRangeSlider', Object);
