...
Custom.Demo.defineController=function(angular,module){Custom.DateRangeSlider.init(angular,module);return Custom.Demo.demo=module.controller('demo',['$scope','$route','$routeParams',function($p1_0,$p1_1,$p1_2){
$p1_0.symbols=(Custom.Demo.$0||[]);$p1_0.pager=new Custom.SymbolPager($p1_0.symbols);var $1_0=Date.get_today().getTime();var $1_1=86400000;var $1_2=365*$1_1;var $1_3=7*$1_1;var $1_4={min:$1_0-$1_2,max:$1_0,low:$1_0-2*$1_3,high:$1_0-$1_3};$p1_0.slider=new Custom.DateRangeSlider({offset:$1_4,date:{low:Custom.DateHelper.date($1_4.low),high:Custom.DateHelper.date($1_4.high)}});var $1_5={type:'GET',url:'api/symbols',dataType:'json',success:function($p2_0,$p2_1,$p2_2){
